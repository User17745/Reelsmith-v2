...
@patch('app.worker.run_subtitles')
@patch('app.worker.run_render')
@patch('app.worker.validate_config')
def test_run_pipeline(mock_validate, mock_render, mock_subtitles, mock_tts, mock_script, mock_mod, mock_extract, mock_score, mock_harvest):
    run_pipeline()
